...
function NameCard() {
    ...
    const hdlAddContact = async (namecardId, token) => {
        try {
            const rs = await axios.post("http://localhost:8000/contact/add/", namecardId, {
    ...
    return (
        <div className="min-h-screen pt-1 w-full">
